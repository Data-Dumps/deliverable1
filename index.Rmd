...
# Alex's code
    ...
    plot2=plot1 + labs(title=titleText, x="")
    plot2
...
# labeling counts of dinos for top six countries
    
    plot3=plot2 + geom_text(vjust=0, #hjust if flipping
                          size = 3,
                          aes(y = Count,
                              label = ifelse(tableFreq$Count>8),
                                      round(tableFreq$Count,2),""))
    

    plot3
    
        
# publish page fully on github by going to repo settings > pages > switch branch to main > save
